...
$(function() {
	...
	$('a[href*="#"]').click(function() {
		...
		var mapLocation = new google.maps.LatLng(54.1874000,37.6299900);
		...
		if ($mapis.length > 0) {
			...
			map = new GMaps({
				...
				el: '#map',
				zoom: 17,
				styles: [{"featureType":"landscape","stylers":[{"saturation":-100},{"lightness":0},{"visibility":"on"}]},{"featureType":"poi","stylers":[{"saturation":-100},{"lightness":50},{"visibility":"simplified"}]},{"featureType":"road.highway","stylers":[{"saturation":-100},{"visibility":"simplified"}]},{"featureType":"road.arterial","stylers":[{"saturation":-100},{"lightness":30},{"visibility":"on"}]},{"featureType":"road.local","stylers":[{"saturation":-100},{"lightness":40},{"visibility":"on"}]},{"featureType":"transit","stylers":[{"saturation":-100},{"visibility":"simplified"}]},{"featureType":"administrative.province","stylers":[{"visibility":"off"}]},{"featureType":"water","elementType":"labels","stylers":[{"visibility":"on"},{"lightness":-25},{"saturation":-100}]},{"featureType":"water","elementType":"geometry","stylers":[{"hue":"#ffff00"},{"lightness":-25},{"saturation":-97}]}]
			});
			...
			map.addMarker({
				...
				infoWindow: {
					content: '<p style="text-align: left !important"><strong>Clean and Shine</strong><br>Детейлинг студия<br/>Тула, улица 1-я Хомутовка, д.36<br/>Тел.: <strong>7 (925) 897-66-77</strong></p>'
				}
			});
